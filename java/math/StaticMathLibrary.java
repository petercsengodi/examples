public class StaticMathLibrary {
	...
	public static boolean InBox(CustomVector p, CustomVector c1, CustomVector c2) {
	...
	public static CustomVector center(CustomVector corner1, CustomVector corner2, CustomVector ret) {
